...
// let trip1: string = `${spacecraftName} takes ${getDaysToLocation(kilometersToMars)} days to get to Mars.`;
// let trip2: string = `${spacecraftName} takes ${getDaysToLocation(kilometersToMoon)} days to get to the Moon.`
// console.log(trip1);
// console.log(trip2);
